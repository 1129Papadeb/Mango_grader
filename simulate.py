...
def capture_and_grade():
    ...
    btn_again.place(x=20, y=260, width=100, height=40)
    btn_exit.place(x=140, y=260, width=100, height=40)
    btn_zoom_in.place(x=280, y=260, width=80, height=40)
    btn_zoom_out.place(x=380, y=260, width=80, height=40)
...
def reset_preview():
    ...
    btn_capture.place(x=20, y=260, width=100, height=40)
    btn_exit.place(x=140, y=260, width=100, height=40)
    btn_zoom_in.place(x=280, y=260, width=80, height=40)
    btn_zoom_out.place(x=380, y=260, width=80, height=40)
    update_preview()
