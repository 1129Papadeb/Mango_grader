...
import random  # for random weight
...
def update_preview():
    ...
    frame_resized = cv2.resize(frame_rgb, (480, 200))
...
def capture_and_grade():
    ...
    btn_again.place(x=60, y=280, width=120, height=30)
    btn_exit.place(x=200, y=280, width=120, height=30)
...
def reset_preview():
    ...
    btn_capture.place(x=60, y=280, width=120, height=30)
    btn_exit.place(x=200, y=280, width=120, height=30)
    update_preview()
...
btn_zoom_in.place(x=340, y=280, width=60, height=30)

btn_zoom_out = tk.Button(root, text="➖ Zoom Out", command=zoom_out, font=("Arial", 10))
btn_zoom_out.place(x=410, y=280, width=60, height=30)
