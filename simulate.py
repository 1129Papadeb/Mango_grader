...
def update_preview():
    ...
    h, w, _ = frame.shape
    # Portrait preview: fix width and compute height
    new_w = 270
    new_h = int(h / w * new_w)
...
def capture_and_grade():
    ...
    # Resize captured frame maintaining portrait orientation
    h, w, _ = frame.shape
    preview_w = 240
...
# Portrait window: narrower width, taller height
root.geometry("320x500")

label_preview = tk.Label(root, bg="black")
label_preview.place(x=25, y=20, width=270, height=360)  # initial, updated by update_preview
